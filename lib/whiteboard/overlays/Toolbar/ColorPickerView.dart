...
class _ColorPickerViewState extends State<ColorPickerView> {
          ...
          child: Card(
            ...
            child: SingleChildScrollView(
              ...
              child: ColorPicker(
                ...
                color: drawOptions == null ? widget.selectedSettingsScribble!.color : drawOptions.colorPresets[drawOptions.currentColor],
  ...
  DrawOptions? _getDrawOptions(){
    if(widget.toolbarOptions.settingsSelected != Toolbar.SettingsSelected.none) return null;
